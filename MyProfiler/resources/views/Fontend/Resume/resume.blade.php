                ...
                <aside class="col-12 col-md-12 col-lg-2">
				    <div class="sidebar box sticky-column">
	                    <ul class="nav">
							...
							<li class="nav__item"><a class="active" href="{{route('resume.user',['id' => $user->id])}}"><i class="icon-file-text"></i>Resume</a></li>
                            <li class="nav__item"><a href="works.html"><i class="icon-codesandbox"></i>Album</a></li>
