		    ...
		    <div class="row sticky-parent">
                ...
                <aside class="col-12 col-md-12 col-lg-2">
				    <div class="sidebar box sticky-column">
	                    <ul class="nav">
							...
							<li class="nav__item"><a class="active" href="{{route('resume.user',['id' => $user->id])}}"><i class="icon-file-text"></i>Tóm tắt</a></li>
                            <li class="nav__item"><a href="works.html"><i class="icon-codesandbox"></i>Kho ảnh</a></li>
		        ...
		        <div class="col-12 col-md-12 col-lg-10">
				    <div class="box box-content">
					    <div class="pb-2">
		                    <h1 class="title title--h1 first-title title__separate">Sự kiện nổi bật</h1>
					    </div>
							...
							<div class="col-12">
								<div class="timeline">
									...
									<article class="timeline__item">
									    <h5 class="title title--h5 timeline__title">{{ $resume->name }}</h5>
										<span class="timeline__period">{{ $resume->start_year}} — {{ $resume->end_year}}</span>
										<p class="timeline__description">{{ $resume->description}}</p>
									</article>
                                    @endforeach
								</div>	
							</div>
								...
								<div class="box box__border">
									...
									<div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-text"><span>Web Design</span><span>100%</span></div>
										</div>
